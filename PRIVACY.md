...
- **API Key Rebrickable** et **identifiants/API Key Brickset** : dans le Keychain iOS, chiffré par Apple.
...
| **BrickLink** | Affichage des prix du marché (neuf/occasion) | Aucun identifiant — simple consultation de page publique |
...
- Vous pouvez révoquer l'accès de BrickScan à tout moment depuis vos paramètres Rebrickable ou Brickset.
